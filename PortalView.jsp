...
<!--  <li class="nav-item" role="presentation">
   ...
   <li class="nav-item" role="presentation">
    <a class="nav-link custom-nav-link" href="#" onclick="showModal()">Contact Admin</a>
   </li>
...
<div class="tab-content custom-tab-content">
  ...
  <!-- Hier muss das Regiestrierungsformular angezeigt werden -->
     
      <!-- Formular für Kontakt zu Admin -->
	    ...
	    <div class="modal-content">
	      ...
	      <h2>Contact Admin</h2>
		      <form action="../jsp/MitarbeiterAppl.jsp" method="get" onsubmit="return validateContactForm()">
		        ...
		        <input type="submit" class="btn btn-primary btn-block mb-4" name="btnSend" value="Send Message" />
		        <button type="button" id="btn" class="btn btn-secondary btn-block mb-4" onclick="closeModal()">Cancel</button>
		      </form>
	    </div>
  </div>
